...
CREATE TABLE `comments` (
  ...
  CONSTRAINT `comments_ibfk_2` FOREIGN KEY (`parentCommentId`) REFERENCES `comments` (`id`)
...
INSERT INTO `comments` VALUES (1,'This is my first comment, tho!',1,NULL,'[]','2024-11-16 11:33:05','2024-11-16 11:33:05'),(2,'Hi, welcome to this blog!',1,1,'[]','2024-11-16 11:36:04','2024-11-16 11:36:04');
...
-- Dump completed on 2024-11-16 19:55:53
